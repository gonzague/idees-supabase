...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:img\\.youtube\\.com)$)$", pathname: "^(?:\\/vi(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "https", hostname: "^(?:^(?:idees\\.gonzague\\.me)$)$", pathname: "^(?:\\/api\\/files(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "http", hostname: "^(?:^(?:127\\.0\\.0\\.1)$)$", port: "8090", pathname: "^(?:\\/api\\/files(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }];
